          ...
          <div className="text-center md:text-left space-y-10 lg:max-w-[400px]">
            ...
            >
              <span style={{color:'rgba(153, 27, 27, 1)'}}>
                <Typewriter
                  words={['Automating Cleanliness, Ensuring Safety.',
                  'Revolutionizing Waste Management for a Cleaner Future.',
                  'Smart Sanitation: Cleaner Spaces, Safer Lives.',
                  'Effortless Waste Segregation, Maximum Efficiency',
                  'Robotic Precision for a Healthier Environment']}
                  loop={true}
                  cursor
                  cursorStyle='|'
                  typeSpeed={150}
