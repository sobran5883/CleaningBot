  ...
  <div className='w-full flex flex-col items-center justify-center'>
      <div className='w-10/12 my-28 flex flex-col items-center justify-center'>
          {Hardwares.map((hardware)=>(
              ...
              <h1 className=' text-base md:text-2xl my-2 underline text-red-800'>{hardware.title}</h1>
              <ul className="list-disc ml-4">
                  <li className='text-sm md:text-lg font-medium'>{hardware.discription1}</li>
                  <li className='text-sm md:text-lg font-medium'>{hardware.discription2}</li>
              </ul>
          </div>
          ))}
      </div>
